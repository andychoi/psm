...
class ActualItem(models.Model):
    ...
    m01 = models.DecimalField(default = 0, decimal_places=1, validators = [MinValueValidator(0), MaxValueValidator(Resource.MAX_MH)])
    m02 = models.DecimalField(default = 0, decimal_places=1, validators = [MinValueValidator(0), MaxValueValidator(Resource.MAX_MH)])
    m03 = models.DecimalField(default = 0, decimal_places=1, validators = [MinValueValidator(0), MaxValueValidator(Resource.MAX_MH)])
    m04 = models.DecimalField(default = 0, decimal_places=1, validators = [MinValueValidator(0), MaxValueValidator(Resource.MAX_MH)])
    m05 = models.DecimalField(default = 0, decimal_places=1, validators = [MinValueValidator(0), MaxValueValidator(Resource.MAX_MH)])
    m06 = models.DecimalField(default = 0, decimal_places=1, validators = [MinValueValidator(0), MaxValueValidator(Resource.MAX_MH)])
    m07 = models.DecimalField(default = 0, decimal_places=1, validators = [MinValueValidator(0), MaxValueValidator(Resource.MAX_MH)])
    m08 = models.DecimalField(default = 0, decimal_places=1, validators = [MinValueValidator(0), MaxValueValidator(Resource.MAX_MH)])
    m09 = models.DecimalField(default = 0, decimal_places=1, validators = [MinValueValidator(0), MaxValueValidator(Resource.MAX_MH)])
    m10 = models.DecimalField(default = 0, decimal_places=1, validators = [MinValueValidator(0), MaxValueValidator(Resource.MAX_MH)])
    m11 = models.DecimalField(default = 0, decimal_places=1, validators = [MinValueValidator(0), MaxValueValidator(Resource.MAX_MH)])
    m12 = models.DecimalField(default = 0, decimal_places=1, validators = [MinValueValidator(0), MaxValueValidator(Resource.MAX_MH)])
