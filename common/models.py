...
class Div(models.Model):
    ...
    head = models.CharField('Circular', max_length=20, blank=True, null=True)
    # models.ForeignKey('users.Profile', related_name='div_head', verbose_name=_('Div head'), on_delete=models.SET_NULL, null=True, blank=True)
...
class Dept(models.Model):
    ...
    cc   = models.CharField(max_length=10, blank=True, null=True)
    head = models.CharField('Circular', max_length=20, blank=True, null=True)
    # models.ForeignKey('users.Profile', related_name='dept_head', verbose_name=_('Dept head'), on_delete=models.SET_NULL, null=True, blank=True)
...
class Team(models.Model):
    ...
    cc   = models.CharField(max_length=10, blank=True, null=True)
    head = models.CharField('Circular', max_length=20, blank=True, null=True)
    # models.ForeignKey('users.Profile', related_name='team_head', on_delete=models.SET_NULL, null=True, blank=True)
